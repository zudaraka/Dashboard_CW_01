...
def attach_metrics(gj_base: dict, mdf: pd.DataFrame, metric: str, threshold_incidence: float) -> dict:
    ...
    for feat in gj["features"]:
        ...
        # color_value: if metric is incidence, grey out 0 by using None
        ...
        # alpha based on incidence threshold (independent of chosen metric)
...
def update():
    ...
    # update color scale & glyph mapping (field name fixed: "color_value")
